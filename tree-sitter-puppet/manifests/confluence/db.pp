...
#
class profile::confluence::db {
  profile_metadata::service { $title:
    human_name => 'Confluence Database',
    ...
    notes      => @("NOTES"),
      The Confluence application server has group `confluence`.
      |-NOTES
  }
  ...
  # Use the database password from hiera.  If the database and the confluence
  ...
  $db_pass = hiera('confluence::dbpass')
